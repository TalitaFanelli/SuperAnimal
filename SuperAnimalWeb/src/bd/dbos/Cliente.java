...
public class Cliente {
	...
	public Cliente (String cpf, String senha, String nome, String sobrenome, String nascimento, String genero,
	...
	public String toString() {
		return "Cliente [cpf=" + cpf + ", senha=" + senha + ", nome=" + nome + ", sobrenome=" + sobrenome
				+ ", nascimento=" + nascimento + ", genero=" + genero + ", cep=" + cep + ", endereco=" + endereco
				+ ", bairro=" + bairro + ", numero=" + numero + ", complemento=" + complemento + ", cidade=" + cidade
				+ ", estado=" + estado + ", email=" + email + ", fixo=" + fixo + ", celular=" + celular + "]";
	}
}